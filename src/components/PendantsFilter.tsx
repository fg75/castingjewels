...
interface PendantsFilterProps {
  onFilterChange: (filters: any) => void;
}

export const PendantsFilter = ({ onFilterChange }: PendantsFilterProps) => {
  ...
  return (
    <div className="flex flex-col gap-1 pb-20">
          ...
          <div className="pb-6 space-y-4 animate-in fade-in slide-in-from-top-2 duration-300">
            <div className="space-y-2">
              ...
              >
                ...
                {["Solitaire", "Halo", "Medallion", "Cross", "Heart", "Geometric", "Symbol", "Locket"].map(s => (
      ...
      {/* 2. SECTION: PRIMARY STONE (Stessa logica Earrings) */}
      <div className="border-b border-gray-100">
        <button 
      ...
      {/* 3. SECTION: SECONDARY STONES (Stessa logica Earrings) */}
      <div className="border-b border-gray-100">
        <button 
